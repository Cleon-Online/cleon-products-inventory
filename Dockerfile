...
FROM maven:3.6.3-jdk-11 as cleon-products-inventory
WORKDIR /cleon-products-inventory
...
ARG DEPENDENCY=/cleon-products-inventory/target/dependency
COPY --from=cleon-products-inventory ${DEPENDENCY}/BOOT-INF/lib /app/lib
COPY --from=cleon-products-inventory ${DEPENDENCY}/META-INF /app/META-INF
COPY --from=cleon-products-inventory ${DEPENDENCY}/BOOT-INF/classes /app
##ENTRYPOINT ["sh", "-c", "java -jar /app.jar"]
ENTRYPOINT ["java","-cp","app:app/lib/*","com.cleon.products.inventory.CleonProductsInventoryApplication"]